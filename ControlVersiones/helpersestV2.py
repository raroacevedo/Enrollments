...
def leer_estudiantes(date='nodate'):
    ...
    columnas_objetivo = {
        ...
        'DOCUMENTO', 'CORREO_ESTUDIANTE', 'NOMBRE_ESTUDIANTE',
        'APELLIDO_ESTUDIANTE', 'COD_INSCRIPCIÓN', 'ESTADO_INSCRIPCIÓN', 'FECHA_ACTIVIDAD_EST', "SOCIO_INTEGRADOR"
    }
    dataframes = []
...
def crearArchivos(data, course_name, course_nrc, course_periodo, BDEstuBS):
    ...
    for index, row in data.iterrows():
        ...
        #tipo de cancelacion
        cancelacion = row['ESTADO_INSCRIPCIÓN']

        #validar socio integrador : Si es APLATAM
        ...
        #    
        if(cancelacion == 'Inscrito'): ##si no hay cancelacion se procede a la inscripcion
